...
<li class="breadcrumb-item"><a href="#!">Modificar cliente</a></li>
                ...
                <div class="row">
                    ...
                    <div class="card" id="cardC" >
                        ...
                        <div class="card-body">
                            <form action="SvModificarC"method="GET">
                                <%   Cliente cliente=(Cliente) misesion.getAttribute("clienteM"); 
                                       Control controladora = new Control(); 
                                    String fecha= controladora.convertiirFecha(cliente.getFechaNac());
                                %>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i data-feather="archive"></i></span>
                                <input type="text" class="form-control" placeholder="Apellido" name="apellido"value="<%=cliente.getApellido()%>">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i data-feather="archive"></i></span>
                                <input type="text" class="form-control" placeholder="Direccion" name="direccion"value="<%=cliente.getDireccion()%>">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i data-feather="archive"></i></span>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i data-feather="archive"></i></span>
                                <input type="text" class="form-control" placeholder="celular" name="celular"value="<%=cliente.getCelular()   %>">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="fecha" type="date" class="form-control" placeholder="FechaN" name="fechaN"value="<%=fecha %>">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email"  class="form-control"  placeholder="Correo electronico" name="email"value="<%=cliente.getEmail()%>">
                            </div>

                                <input type="hidden" name="idC" value="<%=cliente.getIdCliente()     %>">
