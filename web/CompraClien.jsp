        ...
        <section class="pc-container">
            <div class="pcoded-content">
                ...
                <!-- contenido principal-->
                    ...
                    <div class="row">
                        <div class="card ">
                        <div class="card-header"><h5>Buscar cliente</h5></div>
                        <div class="card-body">
                            
                            <form action="SvBuscarC">
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i data-feather="archive"></i> Ingrese DNI</span>
                                <input type="number" class="form-control" placeholder="dni" name="dniC"value="">
                            </div>
                             <button class="btn btn-primary btn-block mb-4" type="submit" >Buscar</button>
                        </div>
                        </form>
                             
                        
                     
                            <h5><%=(String)misesion.getAttribute("msj")  %></h5>
                        
                    </div>
                        
                       
                        <!-- Tarjeta compra servicio -->
                          <form action="SvCompraS" method="POST">
                              <div class="card" id="clienteS" style="display: " >
                            <div class="card-header">
                                <h5>Agregue los datos del cliente</h5>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <%    String valor=(String) misesion.getAttribute("costoS");  
                                ...
                                <button class="btn btn-primary btn-block mb-4" type="submit" onclick="alert('Compra realizada')" >Finalizar compra</button>
                            </div>
