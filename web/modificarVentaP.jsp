                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Modificar venta paquete</a></li>
                    ...
                    <!-- [ form-element ] start -->
                     <div class="card" id="tarjeta3" >
                        ...
                        <div class="card-body ">
                         ...
                         <form action="SvModificarP" method="POST">

                             <% List<Servicio> srvs= controladora.getServicios();
                                Venta v= (Venta)misesion.getAttribute("ventaM");
                                List<Servicio> se= v.getPaquete().getServicios();
                                Servicio ss= se.get(0);
                                String fecha= controladora.convertiirFecha(ss.getFechaS());
                                String valor="";
                                int n= 0;
                                for(Servicio s: srvs)
                                {
                                ...
                                if(a.getCodigoS()==s.getCodigoS()){valor="checked";}}
...
%>
                                ...
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="<%=id%>" name="servicios" <%=valor%> >
                            ...
                            <div class="form-group">
                                <label class="form-label" for="fecha">Fecha de paquete</label>
                            ...
                            <button type="submit"  class="btn btn-primary btn-block mb-4" >Actualizar compra</button>
                            </form>
                            <!-- setpimo -->
                        </div>
