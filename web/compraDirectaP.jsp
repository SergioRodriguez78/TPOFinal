        ...
        <section class="pc-container">
            <div class="pcoded-content">
                ...
                <% Cliente cl = (Cliente) misesion.getAttribute("clientesmodP");
                    String saludo = "Bienvenido " + cl.getNombre() + " " + cl.getApellido();
                    String dni = "Dni " + cl.getDni();
                    String celular = "Celular " + cl.getCelular();
                    String correo = "Correo " + cl.getEmail();
                %>
                <div class="row">
                    <div class="card ">
                        <div class="card-header"><h5><%=saludo%> </h5></div>
                        <div class="card-body">
                            <h5><%=dni%></h5>
                            <h5><%=celular%></h5>
                            <h5><%=correo%></h5>
                            <form action="SvCdirectaP" method="POST">
                                ...
                                <button class="btn btn-primary btn-block mb-4" type="submit" >Comprar</button>
