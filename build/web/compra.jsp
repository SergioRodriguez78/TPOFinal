            ...
            <div class="pcoded-content">
                    ...
                    <div class="page-block">
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="compra.jsp">Nueva compra</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card" id="tarjeta1">
                            <div class="card-header">
                                <h5>¿Paquete o servicio?</h5>
                            </div>
                            <div class="card-body">
                                
                                    <div class="form-group row">
                                        <label class="col-3 col-form-label">Elija una<br> opcion  </label>
                                        <div class="col-9">
                                            <div class="form-check">
                                                <input class="form-check-input position-static"onclick="document.getElementById('tarjeta3').style.display = 'block'; document.getElementById('tarjeta2').style.display = 'none';"  type="radio" name="tipo" id="eleccion" value="paquete" aria-label="...">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input position-static" onclick="document.getElementById('tarjeta2').style.display = 'block'; document.getElementById('tarjeta3').style.display = 'none';" type="radio" name="tipo" id="eleccion" value="servicio" aria-label="...">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    Servicio
                                                </label>
                                            </div>
                    ...
                    <!-- Segunda tarjeta  -->
                        ...
                        <div class="card" id="tarjeta2" style="display:none">
                            ...
                            <div class="card-body" >
                                <form action="SvCompraS" method="GET">
...
%>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input position-static" onclick="" type="radio" name="servicio" id="blankRadio1" value="<%=id%>" aria-label="...">
                                        <label class="form-check-label" for="defaultCheck1">
                                            <%=nombre%>
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="fecha" type="date" class="form-control" placeholder="FechaS" name="fechaS" required>
                                        </div>
                                    </div>
                    ...
                    <div class="card" id="tarjeta3" style="display: none">


                        <div class="card-header">
                            <h5>Elija los servicio del paquete</h5>
                        </div>


                        <div class="card-body ">

                         <form action="SvCompraP" method="GET">
...
%>
                                <div class="form-check ">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="<%=id%>" name="servicios">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="fecha1">Fecha de paquete</label>

                                <div class="input-group mb-3">

                                    <span class="input-group-text"><i data-feather="calendar"></i></span>
                                    <input  type="date" class="form-control" placeholder="FechaS" name="fecha1">
